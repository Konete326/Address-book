        ...
        <div class="card card-user">
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                <label>Stock</label>
                <input type="number" class="form-control" placeholder="Enter stock quantity" name="stock" required>
              </div>
...
if (isset($_POST['sub'])) {
    ...
    if (move_uploaded_file($tmp_name, $image_path)) {
        $sql = "INSERT INTO products (name, price, stock, image_url, description, category_id) 
                VALUES ('$product_name', '$price', '$stock', '$image_path', '$description', '$category_id')";
